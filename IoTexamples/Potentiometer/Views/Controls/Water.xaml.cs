...
namespace Potentiometer.Views.Controls
{
    public sealed partial class Water : UserControl
    {
        ...
        public static readonly DependencyProperty ResistanceProperty =
            DependencyProperty.Register(nameof(Level), typeof(double), typeof(Water), new PropertyMetadata(0.0, Update));
        #endregion
        ...
        public static readonly DependencyProperty MinimumProperty =
            DependencyProperty.Register(nameof(Minimum), typeof(double), typeof(Water), new PropertyMetadata(0.0, Update));
        #endregion
        ...
        public static readonly DependencyProperty MaximumProperty =
            DependencyProperty.Register(nameof(Maximum), typeof(double), typeof(Water), new PropertyMetadata(10.0, Update));
        #endregion
